...
def main(
    ...
    if fewshot_samples_path is not None:
        ...
        fewshot = construct_fewshot(oneshot_input=template_dict['oneshot_input'], oneshot_output=template_dict['oneshot_output'], fewshot_path=fewshot_samples_path, CoT=True, fewshot_count=fewshot_count)
